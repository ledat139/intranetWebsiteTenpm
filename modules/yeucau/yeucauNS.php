...
$listYC = getRow("select * from yeucau WHERE CHUYENYC = 1 order by CREATE_AT desc");
?>
        ...
        <div class="container">
            <div class="">
                <form action="" class="col-12" method="post">
                    ...
                    <a class="btn m-auto w-25 btn-dark col-2" href="?module=yeucau&action=yeucauNS">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr class="my-tr">
                                    ...
                                    <td><a href="?module=yeucau&action=pheduyet&id=<?php echo $YC['MAYC'] ?>" class="btn btn-warning">Phê duyệt<i class="fa-solid fa-check mx-1" style="color: #000;"></i></a></td>
                                </tr>
                        <?php
                            endforeach;
                        endif;
